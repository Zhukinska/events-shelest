const locations = {
  ...
  pool: {
    ...
    `,
    text: 'Великий басейн з видом на річку та ліс, власним баром, екраном для презентацій або кіно, можливістю влаштувати фуршет, барбекю або водні активності. Локація підходить для тихих корпоративних подій: конференцій, воркшопів, стратегічних сесій і спокійного відпочинку з командою.',
    images: [
      './pool/1.jpg',
      './pool/2.jpg',
      './pool/3.jpg',
